...
Description: Adds NewsArticle meta to Yoast graph, YOAST >= 11.0
Version: 0.1.1
...
if ( is_plugin_active( ADEV_YOAST_PLUGIN ) ) {
	add_action( 'plugins_loaded', function () {
		...
		if ( defined( 'WPSEO_VERSION' ) &&
		     version_compare( WPSEO_VERSION, '11.0', '>=' ) ) {
					...
					if( $screen && 'plugins' == $screen->base ) {
						add_action( 'admin_notices', function () {
                            ...
                            <div class="updated notice is-dismissible">
                                <p><?php _e( 'You use <strong>Yoast SEO</strong> version 14.0 or higher, please consider to switch to version >=0.2.0 of <strong>NewsArticle schema for Yoast SEO</strong> plugin', ADEV_YOAST_PTD ); ?></p>
			...
			add_action( 'admin_notices', function () {
                ...
                <div class="updated error">
                    <p>
						<?php
						_e( 'This plugin depends on the <strong>Yoast SEO version 11 or above</strong> plugin.', ADEV_YOAST_PTD );
						echo '<br>';
						printf(
